...
import { useStoreSignup } from '../context/StoreSignupContext';
import { StoreSignupStep } from '../types/storeSignup.types';
...
export function StoreContactStep({ navigation }: Props) {
  ...
  return (
    <KeyboardAwareScreen>
      ...
      <PrimaryButton label="Continuar" onPress={() => goNext(StoreSignupStep.ContatoLoja, navigation)} disabled={!canContinue} />
      <PrimaryButton label="Voltar" variant="ghost" onPress={() => goBack(StoreSignupStep.ContatoLoja, navigation)} />
    </KeyboardAwareScreen>
  );
}
