...
export const IconsActions = {
  ...
  backspace: ({ strokeColor = '#000', fillColor = 'none', ...props }) => (
    <Svg
      xmlns="http://www.w3.org/2000/svg"
      fill={fillColor}
      viewBox="0 0 24 24"
  ...
  play: ({ strokeColor = '#000', fillColor = 'none', ...props }) => (
    <Svg
      xmlns="http://www.w3.org/2000/svg"
      fill={fillColor}
      viewBox="0 0 24 24"
  ...
  stop: ({ strokeColor = '#000', fillColor = 'none', ...props }) => (
    <Svg
      xmlns="http://www.w3.org/2000/svg"
      fill={fillColor}
      viewBox="0 0 24 24"
  ...
  chatBubbleDouble: ({ strokeColor = 'none', fillColor = 'none', ...props }) => (
    <Svg
      xmlns="http://www.w3.org/2000/svg"
      fill={fillColor}
      viewBox="0 0 24 24"
  ...
  thumbsUp: ({ strokeColor = '#000', fillColor = 'none', ...props }) => (
    <Svg
      xmlns="http://www.w3.org/2000/svg"
      fill={fillColor}
      viewBox="0 0 24 24"
  ...
  filter: ({ strokeColor = '#000', fillColor = 'none', ...props }) => (
    <Svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
      height={24}
